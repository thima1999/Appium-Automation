...
export const config: WebdriverIOConfig = {
    ...
    //
    specs: [
        './test/specs/sales-order-mobile.spec.ts'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [{
        ...
        // THE "SELENIUM" SETTINGS (Crucial for your Login Page)
        'appium:ensureWebviewsHavePages': true,
        //'appium:chromedriverAutodownload': true, // Automatically gets the right Selenium driver
        'appium:nativeWebScreenshot': true,
        'appium:newCommandTimeout': 3600,
        
        // UiAutomator2 settings to handle WebView scrolling
    ...
    // The following are supported: Mocha, Jasmine, and Cucumber3
